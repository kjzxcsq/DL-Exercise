...
class TestNeuralNetwork2(unittest.TestCase):
    ...
    def test_data_access(self):
        ...
        self.assertFalse(np.array_equal(out, out2),
                            "Possible reason: Setup of the iris dataset was unsuccessful, check, if your"
